...
<script>
  ...
  gtag('config', 'UA-148760362-1');
    ...
    <title>Super Deluxe Rooms at Hotel Bliss</title>
    <meta charset="utf-8">
...
<body>
    <div class="site-wrap">
        ...
        <div class="slide-one-item home-slider owl-carousel">
            <div class="site-blocks-cover overlay" style="background-image: url(images/superdeluxe1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
                <div class="container">
    ...
    <div class="container"><br>
        <div class="title-box  text-center">
            <h3 class="title-heading"> Super Deluxe Room </h3>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="w3-content w3-display-container">
                    <img class="mySlides" src="images/superdeluxe1.jpg" style="width:100%">
                    <img class="mySlides" src="images/superdeluxe2.jpg" style="width:100%">
                    <!--<img class="mySlides" src="images/parklane/deluxe/dth3.JPG" style="width:100%">-->
            ...
            <div class="col-md-6">
                <p class="abt-text">Our Super Deluxe Room comes with a Double bed and attached bathroom with Free Wifi. It is ideal for more than Two person. It also has 24-hour room service.</p><br>
                <div class="title-box  text-center">
